...
class FiveGSimulatorGUI:
    def __init__(self, root):
        ...
        window_width = int(screen_width / 2.1)
        ...
        ttk.Label(self.bw_control_frame, text="Select test (-verbose,-log,-key,-minrate,-maxrate,-delaytarget):").grid(row=1, column=0, padx=10, pady=10)
